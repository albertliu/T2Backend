			...
			if(data.length>0){
				...
				if(i>0){
					if(path>""){
						...
						arr.push('	<span><img src="/users' + path + '?times=' + (new Date().getTime()) + '" style="width:90px;margin:0px 0px 0px 580px;padding-left:0px;padding-top:850px;"></span>');
						arr.push('</div>');
						arr.push('</div>');
						arr.push('<div style="position: absolute; z-index:40;">');
						arr.push('<div style="float:left;">');
						arr.push('	<span><img src="images/sign_stamp.png" style="width:150px;margin:0px 0px 0px 500px;padding-left:0px;padding-top:820px;opacity:0.7;"></span>');
						arr.push('</div>');
						arr.push('</div>');
						arr.push('</div>');
					}
