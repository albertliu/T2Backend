		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			<div style="position: relative;width:100%;height:99%;">
				<div style="position: absolute; z-index:10;">
					<div style='text-align:center; margin:10px 0 30px 0;'><h3 style='font-size:1.45em;'>特种设备作业人员资格申请表</h3></div>
					<table class='table_resume' style='width:99%;'>
					<tr>
						<td align="center" class='table_resume_title' width='17%' height='55px' colspan="2">姓名</td><td align="center" width='35%'><p style='font-size:1em;' id="name"></p></td>
						<td align="center" class='table_resume_title' width='15%'>性别</td><td align="center" width='12%'><p style='font-size:1em;' id="sexName"></p></td>
					...
					<tr>
						<td align="center" class='table_resume_title' height='55px' colspan="2">工作单位</td><td align="left" colspan="4"><p style='font-size:1em; padding-left:20px;' id="unit"></p></td>
					</tr>
					<tr>
						<td align="center" class='table_resume_title' height='55px' colspan="2">工作单位地址</td><td align="left" colspan="4"><p style='font-size:1em; padding-left:20px;' id="email"></p></td>
					</tr>
					<tr>
						<td align="center" class='table_resume_title' height='55px' colspan="2">通信地址</td><td align="left" colspan="4"><p style='font-size:1em; padding-left:20px;' id="address"></p></td>
					</tr>
					<tr>
						<td align="center" class='table_resume_title' height='55px' colspan="2">邮&nbsp;&nbsp;&nbsp;&nbsp;编</td><td align="center"><p style='font-size:1em;' id="province"></p></td>
						<td align="center" class='table_resume_title'>联系电话</td><td class='table_resume_title' colspan="2"><p style='font-size:1em;' id="mobile"></p></td>
					</tr>
					<tr>
						<td align="center" class='table_resume_title' height='55px' colspan="2">申请作业项目</td><td align="center"><p style='font-size:1em;' id="certName"></p></td>
					...
					<tr>
						<td align="center" class='table_resume_title' height='150px;'>工<br>作<br>简<br>历</td>
					...
					<tr>
						<td align="center" height='100px;'>相<br>关<br>资<br>料</td>
						<td align="left" colspan="5" style="padding-left:10px;line-height:25px;">
							<input type="checkbox" checked />&nbsp;身份证明（复印件1份）<br/>
							<input type="checkbox" checked />&nbsp;学历证明（毕业证复印件1份）<br/>
							<input type="checkbox" checked />&nbsp;体检报告（1份，相应考试大纲有要求的）<br/>
						</td>
					</tr>
					<tr>
						<td align="center" height='120px;'>用<br>人<br>单<br>位<br>意<br>见</td>
						<td align="left" colspan="5">
							<div><p style='font-size:1.2em;text-align:left;'>（申请人在非户籍的工作所在地申请时需填写本栏）</p></div>
							<div style="padding-top:60px;padding-left:50px;">
								<span style='font-size:1.2em;text-align:left;'>用人单位（加盖公章）：</span>
								<span style='font-size:1.2em;text-align:left;padding-left:148px;'>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日</span>
							</div>
						</td>
					</tr>
					<tr>
