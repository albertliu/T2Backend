...
<script language="javascript">
	...
	function getStudentSignList(){
		//alert(refID + ":" + nodeID);
		$.get("studentCourseControl.asp?op=getStudentSignList&nodeID=" + nodeID + "&times=" + (new Date().getTime()),function(data){
			//alert(unescape(data));
			var ar = new Array();
			...
			arr.push("<th width='35%'>课程</th>");
			arr.push("<th width='35%'>签到日期</th>");
			arr.push("<th width='26%'>经办</th>");
			arr.push("</tr>");
			arr.push("</thead>");
