		...
		$.getJSON(uploadURL + "/public/getDiplomaListByBatchID?refID=" + id,function(data){
			...
			if(data.length>0){
				...
				$.each(data,function(iNum,val){
					...
					arr.push('	</table>');	
					arr.push('</div>');
					arr.push('<div style="position: absolute; z-index:30;padding-top:9mm;padding-left:7mm;">');
					...
					arr.push('</div>');	
					arr.push('<div style="position: absolute; z-index:30;padding-top:89mm;padding-left:172mm;">');
